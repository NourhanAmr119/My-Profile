...
namespace GameRental
{
    public partial class Form2 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'gametabelDataSet1.User' table. You can move, or remove it, as needed.
        ...
        private void button1_Click(object sender, EventArgs e )
        {
            ...
            sQLconnection.Open();
            sqlCommand.CommandText = "Insert into User values('" + textBox1.Text + "','" + textBox2.Text + "') ";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand.Connection = sQLconnection;
            sQLconnection.Open();
            sqlCommand.CommandText = "UPDATE  User SET NAME = '" + textBox2.Text + "'where UserName '" + textBox1.Text + "' ";
            sqlCommand.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand.Connection = sQLconnection;
            sQLconnection.Open();
            sqlCommand.CommandText = "Delete From User where UserName =  '" + textBox1.Text + "' ";
            sqlCommand.ExecuteNonQuery();
        ...
        {
            this.userTableAdapter.Fill(this.gametabelDataSet1.User);
